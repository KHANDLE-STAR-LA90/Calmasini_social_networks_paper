---
title: "social nets recoding longitudinal 2"
output: pdf_document
---

This is the same as before, the only difference is that I'm using wave 2 data so also standardizing wave 2 senas measures and i added retirement status. 
```{r, include=FALSE}
...
khandle <- read_sas("/Users/ccalmasini/Desktop/Camilla KHANDLE/Datasets/khandle_all_waves_20210108.sas7bdat")
...
dat_plots2$support <- factor(dat_plots2$support, levels=c("marital status", "volunteer", "relatives", "children", "friends", "confidante"))
  
png("/Users/ccalmasini/Desktop/Camilla KHANDLE/social_nets_plot_v3.png", units="in", width=6, height=5, res = 300)
