...
stargazer(mod1_asian, mod2_asian, type='html', ci = TRUE, title = 'Regression of vrmemz on integration score for Asian participants', out = '/Users/ccalmasini/Desktop/Camilla KHANDLE/social_networks_paper/Tables/asian_vrmemz.html')
...
#table for both
stargazer(mod1_asian, mod2_asian, mod1c_asian, mod2c_asian, type='text', ci = TRUE, title = 'Regression of vrmemz on integration score (1, 2) and confidante (3, 4) for Asian participants', out = '/Users/ccalmasini/Desktop/Camilla KHANDLE/social_networks_paper/Tables/asian_wave1.txt')
```
...
stargazer(summary(mod1_long_asian)$coef, summary(mod2_long_asian)$coef, type = "html", ci = TRUE, title = "Regression of vrmemz on integration score for Asian participants using w1 and w2 data", 
...
stargazer(summary(mod1c_long_asian)$coef, summary(mod2c_long_asian)$coef, type = "html", ci = TRUE, title = "Regression of vrmemz on confidante for Asian participants using w1 and w2 data", 
...
stargazer(mod1c_latin, mod2c_latin, type='html', ci = TRUE, title = 'Regression of vrmemz on confidante for Latino participants', out = '/Users/ccalmasini/Desktop/Camilla KHANDLE/social_networks_paper/Tables/latin_confidante.html')
```
...
stargazer(summary(mod1c_long_latino)$coef, summary(mod2c_long_latino)$coef, type = "html", ci = TRUE, title = "Regression of vrmemz on confidante for Latino participants using w1 and w2 data", 
