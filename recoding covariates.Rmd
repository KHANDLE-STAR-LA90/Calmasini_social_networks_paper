...
khandle <- read_sas("../../Dropbox/KHANDLE/Raw KHANDLE Data/Most Recent Raw Data Sets/archive/29Oct2020/khandle_baseline_20201029.sas7bdat")
```
...
ADL <- dat %>%
  ...
  mutate(ADL1 = ifelse(W1_DAILY_LIVING_ADL1 >= 1 & W1_DAILY_LIVING_ADL1 <= 4, W1_DAILY_LIVING_ADL1, NA),
         ...
         # The line below is incorrect - should be W1_DAILY_LIVING_ADL9 instead of W1_DAILY_LIVING_ADL2
         # Fortnately, all participants incorrectly coded (n = 9) were missing at least one other ADL, so the ADL variable wasn't affected
         # I've commented out the incorrect line and corrected it below, but there should be no change to the results
...
ADL_IADL <- dat %>%
  ...
  mutate(ADL_IADL1 = ifelse(W1_DAILY_LIVING_ADL1 >= 1 & W1_DAILY_LIVING_ADL1 <= 4, W1_DAILY_LIVING_ADL1, NA),
         ...
         # same error as above - will comment out incorrect line and correct below
         # still has no effect on ADL_IADL calculation
